...
/**
 * struct shash_node_s - a program node of a sorted hash table
 * @key: The key, string
...
/**
 * struct shash_table_s - a program of sorted hash table data structure
...
/**
 * struct hash_node_s - a program node of a hash table
 * @key: The key, string
 * The key is unique in the HashTable
 * @value: The value corresponding to a key
...
/**
 * struct hash_table_s - a program of hash table data structure
 * @size: The size of the array
 * @array: An array of size @size
 * Each cell of this array is a pointer to the first node of a linked list,
 * because we want our HashTable to use a Chaining collision handling
